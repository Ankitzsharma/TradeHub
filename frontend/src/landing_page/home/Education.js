...
<a href='www.google.com' className='text-decoration-none pt-3'>Varsity <i className="fa-solid fa-arrow-right-long"></i></a>
...
<a href='www.microsoft.com' className='text-decoration-none pt-3'>Trading Q&A <i className="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
        </div>
    );
